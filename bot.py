...
from alerts.commands import (
    ...
    papertrade_cmd, portfolio_cmd # New trade commands
)
...
async def papertrade_wrapper(update, context): await papertrade_cmd(update, context, user_manager, portfolio_manager)
async def portfolio_wrapper(update, context): await portfolio_cmd(update, context, user_manager, portfolio_manager)
