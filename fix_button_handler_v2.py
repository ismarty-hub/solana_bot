"""Reconstruct button_handler in alerts/commands.py to fix corruption and add missing handlers (v2)."""
...
if start_idx != -1:
    ...
    # We look for the next async def or def that is NOT indented (top level)
